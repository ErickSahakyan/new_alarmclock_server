...
const StartServer = () => {
    ...
    /** Routes */
    router.use('/api/auth', userRoute_1.default);
    router.use('/api/alarm', alarmRoute_1.default);
    /** HealthCheck */
    ...
    http_1.default.createServer(router).listen(config_1.config.server.port, () => Logging_1.default.info(`Server is running on port: http://localhost:${config_1.config.server.port}`));
};
